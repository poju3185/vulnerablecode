...
class AnchoreImporter(Importer):
    license_url = "https://github.com/anchore/nvd-data-overrides/blob/main/LICENSE"
    spdx_license_expression = "CC-BY-4.0"
    url = "git+https://github.com/anchore/nvd-data-overrides"
    importer_name = "Anchore NVD Data Overrides Importer"
